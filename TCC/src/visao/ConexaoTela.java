 ...
 * @author Bruno
 */
public class ConexaoTela extends javax.swing.JDialog {

    /**
     * Creates new form dConexaoTela
     */
    public ConexaoTela(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ConexaoTela dialog = new ConexaoTela(new javax.swing.JFrame(), true);
